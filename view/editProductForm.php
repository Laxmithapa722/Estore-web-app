...
<div class="row">
    ...
    <div class="col-sm-6 text-center box">Edit Product</div>
    <div class="col-sm-3"></div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 jumbotron">
        <form class="form-horizontal" action="?action=editProduct&ProductID=<?= $ProductID ?>" method="post" novalidate>
            <div class="form-group">
                <label class="control-label" for="ProductID">Product ID</label>

                <input class="form-control" type="text" name="ProductID" readonly="true" value="<?= $ProductID ?>" />
            </div>
            ...
            <br/>
            <div class="form-group">
                <input type="submit" value="Save" class="btn btn-primary btn-block" name="editProduct" />
            </div>
        </form>
    </div>
    <div class="col-sm-3"></div>
