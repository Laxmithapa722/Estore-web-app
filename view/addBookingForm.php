...
<div class="row">
    ...
    <div class="col-sm-6 text-center box">Add Booking</div>
    <div class="col-sm-3"></div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6 jumbotron">
        <form class="form-horizontal" action="?action=addBooking" method="post" novalidate>
            ...
            <br/>
            <div class="form-group">
                <input type="submit" value="Save" class="btn btn-primary btn-block" name="addBooking" />
            </div>
        </form>
    </div>
    <div class="col-sm-3"></div>
